...
export const mods: Mod[] = [
  ...
  },
  {
    ...
    description: [
      ...
      "A live carry-weight readout appears on the bag screen, and per-item weight overrides are a true override — changing bag capacity, the weight readout, and the stamina cost together. Every option is configurable on the in-game Mods page.",
    ],
    features: [
      "Bag fullness scales how fast climbing tires you",
      "Tunable: empty always 1×, full up to 5× (default 2×)",
      "Live carry-weight readout on the bag screen",
      "Per-item weight overrides — a true override (capacity, readout, and stamina cost)",
      "Per-climber weight, so it's co-op safe",
  ...
  },
  {
    ...
    features: [
      ...
      "Skip intro videos and studio logos",
      "Remove fades — instant transitions, no fade to black",
